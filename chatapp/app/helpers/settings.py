...
# Default values
DEFAULT_APP_TITLE = "Manufacturing Digital Thread"
DEFAULT_APP_SUBTITLE = "AI-Powered Universal Knowledge Graph on AWS"
...
COLOR_PRESETS = {
    ...
    "purple": {"primary": "#0f4c81", "secondary": "#6b21a8", "name": "Default"},
