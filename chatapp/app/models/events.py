...
class GuardrailEvent(SSEEvent):
    """Event indicating a guardrail intervention was detected.
    
    This event is emitted when content evaluation against Bedrock guardrails
    detects a violation. The guardrail may be in blocking or detection mode
    depending on the configuration. The model may independently refuse to
    answer regardless of the guardrail mode.
